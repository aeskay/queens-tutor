            ...
            <nav className="bg-white border-b border-slate-100 sticky top-0 z-30 shrink-0">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-black text-slate-900 text-lg" style={{ fontFamily: 'Outfit, sans-serif' }}>Queen's Classes</span>
                    </div>

                    <div className="flex gap-1 md:gap-4 absolute left-1/2 -translate-x-1/2">
                        <div className="px-4 py-2 bg-slate-100 rounded-full text-sm font-bold text-slate-900">
                            My Classes
                        </div>
                        <button 
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        <div
                            ...
                            className="w-9 h-9 bg-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-sm cursor-pointer hover:bg-blue-700 transition-colors"
                        >
