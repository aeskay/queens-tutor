                    ...
                    >
                        ...
                        <div className="p-5 flex flex-col flex-1">
                            ...
                            <button 
                                ...
                                className="absolute top-12 right-3 w-8 h-8 flex items-center justify-center rounded-full bg-slate-50 text-slate-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 hover:bg-red-50 hover:text-red-500 transition-all"
                            >
